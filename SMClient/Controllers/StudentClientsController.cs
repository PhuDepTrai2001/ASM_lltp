...
namespace SMClient.Controllers
{
    public class StudentClientsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Rollnumber,Name,Birthday,Email,Introduction,Genre")] StudentClient studentClient)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Rollnumber,Name,Birthday,Email,Introduction,Genre")] StudentClient studentClient)
        {
            if (ModelState.IsValid)
            {
                ServiceClient client = new ServiceClient();
        ...
        public ActionResult Delete(int id)
        {
            ...
            StudentClient studentClient = ConvertTypeHelper.ConvertServiceStudentToViewStudent(serviceClient.GetStudentById(id));
